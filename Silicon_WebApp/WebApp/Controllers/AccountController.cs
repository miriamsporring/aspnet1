...
public class AccountController(UserManager<UserEntity> userManager, ApplicationContext context) : Controller
{
	...
	public async Task<IActionResult> Details()
	{
		...
		var viewModel = new AccountDetailsVieModel
		{
	...
	[HttpPost]
	public async Task<IActionResult> UpdateBasicInfo(AccountDetailsVieModel model)
	{
	...
	[HttpPost]
	public async Task<IActionResult> UpdateAddressInfo(AccountDetailsVieModel model)
	{
